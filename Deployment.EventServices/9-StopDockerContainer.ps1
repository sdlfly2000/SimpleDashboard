...
Write-Host "Stop AuthServiceEventServices docker Container" -ForegroundColor DarkCyan
$Password = "sdl@1215"
$User = "sdlfly2000"
$ComputerName = "homeserver2"
$Command = 'sudo docker service rm APP_AuthServiceEventServices'
...
Write-Host "Stop AuthServiceEventServices docker Container: $result" -ForegroundColor DarkCyan
$stream.Read()
