...
Write-Host "Create AuthServiceEventServices docker image" -ForegroundColor DarkCyan
$Password = "sdl@1215"
$User = "sdlfly2000"
$ComputerNames = @("homeserver2")
$Command = 'sudo docker build -t authserviceeventservices:latest /home/sdlfly2000/Projects/AuthServiceEventServices/'
...
foreach($ComputerName in $ComputerNames){
	...
	Write-Host "Create AuthServiceEventServices docker image on $ComputerName : $result" -ForegroundColor DarkCyan
	$stream.Read()
}
