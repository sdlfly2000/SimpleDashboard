...
$Command = 'sudo docker stack deploy -c /home/sdlfly2000/Projects/SimpleDashboard/docker-compose.yml APP'
...
Write-Host "Run SimpleDashboard docker image on : $result" -ForegroundColor DarkCyan
$stream.Read()
