...
Write-Host "UnZip SimpleDashboard" -ForegroundColor DarkCyan
$Password = "sdl@1215"
$User = "sdlfly2000"
$ComputerNames = @("homeserver2","homeserver")
$Command = 'sudo unzip -o /home/sdlfly2000/Projects/SimpleDashboard/SimpleDashboard.zip -d /home/sdlfly2000/Projects/SimpleDashboard/'
...
foreach($ComputerName in $ComputerNames){
	...
	Write-Host "UnZip SimpleDashboard on $ComputerName : $result" -ForegroundColor DarkCyan
	$stream.Read()
}
